...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './post-rack.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTRACK_LIST actions', async () => {
    ...
    it('dispatches FETCH_POSTRACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POSTRACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POSTRACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POSTRACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POSTRACK actions', async () => {
      const expectedActions = [
        {
