...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AMMENITIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_AMMENITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AMMENITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AMMENITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AMMENITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AMMENITIES actions', async () => {
      const expectedActions = [
        {
