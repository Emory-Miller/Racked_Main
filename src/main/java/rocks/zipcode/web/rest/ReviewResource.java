...
/**
 * REST controller for managing {@link rocks.zipcode.domain.Review}.
 */
@RestController
@RequestMapping("/api")
public class ReviewResource {
     ...
     */
    @GetMapping("/reviews")
    public List<ReviewDTO> getAllReviews(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
